...
# c++STL→golang
## 　動機
atcoderにおいて，問題を速く解く能力が必須であります．c++には豊富な競技プログラミングに便利な標準ライブラリが用意されています．しかし，go言語で競技プログラミングに挑戦しようとすると自分で実装しなければいけない部分が多いことに気づきました．c++の標準ライブラリをgo言語で書いていきたいと思います．スニペットにご利用ください．
